...
export class OrderService {
    public static async getUserOrders(headers: any): Promise<Orders> {
        const userOrders: Orders = await CRUDServices.getData(
            config.API_URL + '/api/client/order',
            headers,
        );
        return userOrders;
    }
    ...
    public static async getAllOrders(): Promise<OrderCarts> {
        const orders: OrderCarts = await CRUDServices.getData(
            config.API_URL + '/api/admin/orders',
        );
        return orders;
    }
    ...
    public static async deleteUserOrder(body: {}, headers?: {}): Promise<Data> {
        const response: Data = await CRUDServices.putData(
            config.API_URL + '/api/client/order/delete',
            body,
            headers,
        );
        return response;
    ...
    public static async getOrdersHistory(headers?: {}): Promise<OrderCarts> {
        const orders: OrderCarts = await CRUDServices.getData(
            config.API_URL + '/api/client/orderHistory',
            headers,
        );
        return orders;
    }

    public static async deleteAdminOrder(
        body: {},
        headers?: {},
    ): Promise<Data> {
    ...
    public static async updateAdminOrder(
        body: {},
        headers?: {},
    ): Promise<Data> {
        const response: Data = await CRUDServices.putData(
