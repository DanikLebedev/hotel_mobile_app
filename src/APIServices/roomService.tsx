...
export class RoomService {
    public static async getAllRooms(): Promise<Rooms> {
        const rooms: Rooms = await CRUDServices.getData(config.API_URL + '/api/admin/room');
        return rooms;
    }
    ...
    public static async getRoomById(id: string | undefined): Promise<Rooms> {
        const rooms: Rooms = await CRUDServices.getData(config.API_URL + `/api/client/rooms/${id}`);
        return rooms;
    }
